...
export const metadata: Metadata = { title: "Request endorsement" };

export default async function EndorsePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <h1 style={{ fontSize: 26, marginBottom: 6 }}>Request an endorsement</h1>
